 ...
 */
void SButtonVirtual::SetLongClick( uint16_t tm ){
   TM_long_click     = tm;
}
 ...
 */
void SButtonVirtual::SetAutoClick( uint16_t tm1, uint16_t tm2 ){
   TM_auto_click     = tm1;
 ...
 */
void SButtonVirtual::SetMultiClick( uint16_t tm ){
   TM_seq_click      = tm;  
}
...
// Press button fixed 
   if( is_click == true && State == false && (ms-Ms1)>TM_bounce ){
       ...
       Ms2    = ms;
       if( TM_long_click == 0 && TM_auto_click == 0 && MultiClickCount == 0 && TM_seq_click == 0 )return SB_CLICK;
   }
...
// All flags reset       
 ...
 // Short click fixed
      ...
      if( TM_seq_click == 0 && (TM_long_click != 0 || TM_auto_click != 0 || TM_seq_click != 0 ) && !Long_press_state && !Auto_press_state )return SB_CLICK;
   } 
